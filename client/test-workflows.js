  ...
  if (fs.existsSync(filePath)) {
    ...
    requiredImports.forEach(importName => {
      if (content.includes(importName)) {
        console.log(`✅ ${filePath} - Import ${importName} OK`);
      } else {
        console.log(`❌ ${filePath} - Import ${importName} MANQUANT`);
      }
    });
  }
};

// Vérifier les imports dans ProductProcessWorkflow
checkImports('client/src/components/ProductProcessWorkflow.tsx', [
  'useState',
  'useEffect',
  'Dialog',
  'Checkbox',
...
// Vérifier les imports dans les pages produits
productPages.forEach(page => {
  checkImports(page, [
    'useAuth',
    'useToast',
