...
const KPIPage: React.FC = () => {
  ...
  const barData = {
    ...
    datasets: [
      {
        label: 'Gains obtenus (€)',
        data: [2000, 3500, 4000, 2500, 5000, 9000],
        backgroundColor: '#2563eb',
        borderRadius: 8,
      },
      {
        label: 'Gains potentiels (€)',
        data: [8000, 12000, 10000, 9000, 11000, 8000],
  ...
  const pieData = {
    labels: ['TICPE', 'URSSAF', 'CIR', 'CEE'],
    datasets: [
      {
        label: 'Répartition des gains',
        data: [18000, 12000, 8000, 4000],
        backgroundColor: ['#2563eb', '#60a5fa', '#fbbf24', '#10b981'],
        borderWidth: 1,
      }
    ]
  };
