...
export default function CourtageEnergieAudit() {
  ...
  const auditType = "courtage-energie";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto p-6">
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-4">
              <h1 className="text-3xl font-bold">Courtage Énergie</h1>
              <Button
                variant="destructive"
                onClick={handleReset}
        ...
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Courtage Énergie</CardTitle>
            <p className="text-m text-muted-foreground">
              Optimisez vos contrats d'énergie et réduisez vos factures !
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Dialog open={showCharterDialog} onOpenChange={setShowCharterDialog}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Charte Contractuelle Courtage Énergie</DialogTitle>
              <DialogDescription>
            ...
            <div className="max-h-[60vh] overflow-y-auto p-4 bg-gray-50 rounded-md my-4">
              <h3 className="text-lg font-semibold mb-4">Charte du Courtage Énergie</h3>
              <p className="mb-4">
        ...
        <Dialog open={showExpertDialog} onOpenChange={setShowExpertDialog}>
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              <DialogTitle>Sélection de l'expert Courtage Énergie</DialogTitle>
              <DialogDescription>
                Choisissez un expert spécialisé en courtage énergétique pour votre audit
              </DialogDescription>
            </DialogHeader>
