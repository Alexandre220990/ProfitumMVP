...
const socialExperts: Expert[] = [
  {
    id: 1,
    name: "Isabelle Martin",
    company: "Social Audit France",
    speciality: "Expert URSSAF",
    experience: "20 ans d'expertise",
    compensation: 35,
    description: "Spécialiste en optimisation des charges sociales et conformité URSSAF"
  },
  {
    id: 2,
    name: "François Dubois",
    company: "OptimSocial",
    speciality: "Consultant Social",
    experience: "15 ans d'expérience",
    compensation: 32,
    description: "Expert en droit social et optimisation des cotisations sociales"
  }
];
...
const documentsList: DocumentItem[] = [
  ...
  { id: "urssaf", label: "Déclarations URSSAF", uploadedFiles: [] },
  { id: "registre", label: "Registre unique du personnel", uploadedFiles: [] },
  { id: "conventions", label: "Conventions collectives", uploadedFiles: [] },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto p-6">
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-4">
              <h1 className="text-3xl font-bold">Audit Social</h1>
              <Button
                variant="destructive"
                onClick={handleReset}
        ...
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Audit Social</CardTitle>
            <p className="text-m text-muted-foreground">
              Optimisez vos charges sociales et sécurisez votre conformité !
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Dialog open={showCharterDialog} onOpenChange={setShowCharterDialog}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Charte Contractuelle Social</DialogTitle>
              <DialogDescription>
            ...
            <div className="max-h-[60vh] overflow-y-auto p-4 bg-gray-50 rounded-md my-4">
              <h3 className="text-lg font-semibold mb-4">Charte de l'Audit Social</h3>
              <p className="mb-4">
        ...
        <Dialog open={showExpertDialog} onOpenChange={setShowExpertDialog}>
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              <DialogTitle>Sélection de l'expert Social</DialogTitle>
              <DialogDescription>
                Choisissez un expert spécialisé en audit social pour votre dossier
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              {socialExperts.map((expert) => (
                <div
                  key={expert.id}
                  className={cn(
