...
const ExpertProfile = () => {
  ...
  const expertData = { id: "1", name: "Jean Dupont", company: "Cabinet Fiscal Plus", specializations: ["TICPE", "CIR"], experience: 15, description: "Expert reconnu en optimisation fiscale avec une expertise particulière en TICPE", rating: 4.8, commission: 15, location: "Paris, France", completedAudits: 150, successRate: 95 };
