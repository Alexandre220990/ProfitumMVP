...
const DossierClient13 = () => {
  const [, setLocation] = useLocation();

  const documents = [
    { name: "Déclarations DFS (2024)", url: "#", type: "PDF" },
    { name: "Documents fiscaux", url: "#", type: "PDF" },
      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Dossier DFS - SARL TechnoPlus</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="font-medium">SARL TechnoPlus</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">DFS</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Montant estimé</p>
              <p className="font-medium">7 400 €</p>
            </div>
          </div>
...
export default DossierClient13;
