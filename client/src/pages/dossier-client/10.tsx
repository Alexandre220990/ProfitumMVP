...
const DossierClient10 = () => {
  ...
  const documents = [
    ...
    { name: "Contrats de travail", url: "#", type: "PDF" },
  ];
      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Dossier Social - Antoine Rousseau</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="font-medium">Antoine Rousseau</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Date de création</p>
              <p className="font-medium">08/02/2024</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Type d'audit</p>
              <p className="font-medium">Audit Social</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Montant estimé</p>
              <p className="font-medium">12 200 €</p>
            </div>
          </div>
...
export default DossierClient10;
