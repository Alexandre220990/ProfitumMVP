      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Dossier TICPE - Transports Méditerranée</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="font-medium">Transports Méditerranée</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Date de création</p>
              <p className="font-medium">12/02/2024</p>
            </div>
            <div>
...
export default DossierClient12;
