...
const DossierClient11 = () => {
  const [, setLocation] = useLocation();

  const documents = [
    { name: "Déclarations MSA (2024)", url: "#", type: "PDF" },
    { name: "Attestations cotisations", url: "#", type: "PDF" },
    { name: "Justificatifs activité", url: "#", type: "PDF" },
  ];
      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle>Dossier MSA - Ferme Bio des Collines</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="font-medium">Ferme Bio des Collines</p>
            </div>
            <div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-2">
              <Button variant="success">Dossier accepté</Button>
            </div>
          </div>
        </CardContent>
      </Card>
...
export default DossierClient11;
