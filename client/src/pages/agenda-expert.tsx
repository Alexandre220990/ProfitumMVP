...
import { Calendar, Users, AlertTriangle, RefreshCw, Briefcase } from "lucide-react";
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Mon Agenda Expert</h1>
                <p className="text-gray-600">Gérez vos rendez-vous, missions et échéances</p>
              </div>
            </div>
            <Button
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{stats.documentsToValidate}</p>
                </div>
                <div className="bg-green-100 p-3 rounded-full">
