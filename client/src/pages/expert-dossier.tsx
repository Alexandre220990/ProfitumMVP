...
const dossier = {
  ...
  client: {
    ...
    siren: '123 456 789',
    contact: 'jean.martin@transports.fr',
    phone: '06 12 34 56 78',
    address: '12 rue de la Gare, 75010 Paris',
  },
  type: 'TICPE',
  status: 'En cours',
  progress: 70,
  ...
  documents: [
    { name: 'Factures carburant.pdf', date: '12/05/2024', url: '#' },
    { name: 'Relevé kilométrique.xlsx', date: '10/05/2024', url: '#' },
  ],
  messages: [
    { from: 'client', content: 'Bonjour, voici les documents demandés.', date: '12/05/2024 09:12' },
    { from: 'expert', content: 'Merci, je commence l’analyse.', date: '12/05/2024 10:05' },
  ]
};

const ExpertDossier: React.FC = () => {
  return (
