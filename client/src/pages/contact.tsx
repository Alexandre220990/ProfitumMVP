...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      {/* Hero Section */}
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
              Une question ? Un projet ? Notre équipe est à votre écoute pour vous accompagner dans vos démarches d'optimisation financière.
            </p>
          </div>
        </div>
      </section>
