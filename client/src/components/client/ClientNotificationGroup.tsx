/**
 * ClientNotificationGroup - Composant pour afficher une notification parent avec ses enfants
 * Système expand/collapse pour visualiser les détails (version Client)
 * Groupement par PRODUIT/DOSSIER
 */
...
interface ClientNotificationGroupProps {
  notification: Notification;
  onNotificationClick: (notification: Notification) => void;
  onDismiss: (notificationId: string) => void;
}

export function ClientNotificationGroup({ 
  notification, 
  onNotificationClick, 
  onDismiss
}: ClientNotificationGroupProps) {
