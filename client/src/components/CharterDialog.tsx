          ...
          export default function CharterDialog({ open, onClose, onScrollEnd, auditType }: CharterDialogProps) {
            ...
            const handleScroll = () => {
              if (contentRef.current) {
                ...
                if (scrollTop + clientHeight >= scrollHeight - 10) {
                  ...
                  onScrollEnd(); // ✅ Marque la lecture comme complète
                }
              }
            };
            ...
            const handleClose = () => {
              if (canClose.current) {
                onClose(); // ✅ Ferme la charte après validation
              }
            };
            ...
            return (
              <Dialog open={open} onOpenChange={onClose}>
                <DialogContent className="max-w-3xl">
                  <DialogHeader>
                    <DialogTitle>Charte d'Engagement Client - {auditType.toUpperCase()}</DialogTitle>
                    <DialogDescription>
          ...
          <p className="font-semibold">
            📩 Contact : Pour toute question relative à cette charte, le Client peut contacter Profitum à l’adresse suivante : 
            <a href="mailto:contact@profitum.fr" className="text-blue-500 underline"> contact@profitum.fr</a>
          </p>
        </div>

<DialogFooter className="flex justify-center">
          <Button onClick={handleClose} disabled={!canClose.current}>
            ✅ Fermer et Valider
          </Button>
        </DialogFooter>
      </DialogContent>
