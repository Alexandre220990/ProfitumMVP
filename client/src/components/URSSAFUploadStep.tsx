...
interface URSSAFUploadStepProps {
...
// Types de documents requis pour URSSAF
const REQUIRED_DOCUMENTS = [
  ...
  },
  {
    ...
    description: 'Fiches de paie des employés (3 derniers mois)',
    icon: FileText,
    required: true
  }
];

export default function URSSAFUploadStep({
  clientProduitId,
  onStepComplete,
  onDocumentsUploaded
    ...
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Documents requis pour URSSAF
        </h2>
        <p className="text-gray-600">
          Veuillez fournir les documents suivants pour valider votre éligibilité URSSAF
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">Vous pouvez maintenant valider votre éligibilité URSSAF</p>
                </div>
              </div>
              <Button
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Les fiches de paie doivent couvrir les 3 derniers mois</li>
