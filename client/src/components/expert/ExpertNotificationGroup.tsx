/**
 * ExpertNotificationGroup - Composant pour afficher une notification parent avec ses enfants
 * Système expand/collapse pour visualiser les détails (version Expert)
 */
...
interface ExpertNotificationGroupProps {
  notification: Notification;
  onNotificationClick: (notification: Notification) => void;
  onDismiss: (notificationId: string) => void;
}

export function ExpertNotificationGroup({ 
  notification, 
  onNotificationClick, 
  onDismiss
}: ExpertNotificationGroupProps) {
