    ...
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="flex items-center flex-shrink-0 px-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 min-w-0">
                    ...
                    <p className="text-sm text-gray-500 truncate">Administration</p>
                  </div>
                </div>
              </div>
      ...
      <div className="lg:pl-64 flex flex-col flex-1 min-h-screen">
        ...
        <div className="sticky top-0 z-30 flex-shrink-0 flex h-16 bg-white shadow">
          <button
            type="button"
            className="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500 lg:hidden min-h-[44px] min-w-[44px]"
          ...
          <div className="flex-1 px-2 sm:px-4 flex justify-between items-center">
            ...
            <div className="ml-2 sm:ml-4 flex items-center md:ml-6 flex-shrink-0">
              {/* Notifications */}
              ...
              <div className="ml-2 sm:ml-3 relative">
                <div>
                  <button
                    type="button"
                    className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 min-h-[44px]"
