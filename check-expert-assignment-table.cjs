...
async function checkExpertAssignmentTables() {
  try {
    ...
    // 3. Lister toutes les tables contenant "assignment"
    console.log('\n3. Recherche de toutes les tables contenant "assignment"...');
    try {
      const { data: tables, error: tablesError } = await supabase
        .rpc('get_tables_with_assignment');
    ...
    // 4. Vérifier les assignations du client Grandjean Laporte
    console.log('\n4. Vérification des assignations du client Grandjean Laporte...');
    ...
    // 5. Vérifier les assignations de l'expert Alexandre
    console.log('\n5. Vérification des assignations de l\'expert Alexandre...');
