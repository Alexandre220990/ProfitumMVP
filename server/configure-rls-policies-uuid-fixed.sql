-- Configurer des politiques RLS avec les bons types UUID
-- Date: 2025-01-24
...
-- auth_id est de type UUID, donc on compare avec auth.uid() directement
...
-- clientId est de type UUID, donc on compare avec auth.uid() directement
