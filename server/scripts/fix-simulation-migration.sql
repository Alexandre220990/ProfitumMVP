-- =====================================================
-- CORRECTION MIGRATION SIMULATION
-- Date: 2025-01-30
-- =====================================================
...
-- 3. FONCTION POUR MIGRER MANUELLEMENT UNE SESSION
CREATE OR REPLACE FUNCTION migrate_session_manually(
...
BEGIN
    ...
    LOOP
        ...
        SELECT migrate_session_manually(session_record.session_token, 'wamuchacha@gmail.com') INTO migration_result;
