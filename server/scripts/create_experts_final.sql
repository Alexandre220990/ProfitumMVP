...
-- Utilise les vrais auth_id des utilisateurs Supabase Auth créés

-- Nettoyage préalable (optionnel - décommentez si nécessaire)
-- DELETE FROM "Expert" WHERE email LIKE '%demo%' OR email LIKE '%@cabinet%' OR email LIKE '%@social%' OR email LIKE '%@associes%' OR email LIKE '%@consulting%' OR email LIKE '%@bernard%' OR email LIKE '%@roussel%' OR email LIKE '%@moreau%' OR email LIKE '%@leroy%' OR email LIKE '%@petit%' OR email LIKE '%@durand%';

-- Insertion des experts avec les vrais auth_id
INSERT INTO "Expert" (
    id,
    email,
    password,
...
(
    ...
    NULL,
    'scale',
    '990d90b0-f10f-45b5-893d-fd438edd0c9e',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'growth',
    'a2c5b6a1-6464-4a5d-95da-f769e61faf48',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'scale',
    '4e184a7e-9fa6-480c-9dae-6f8b9714c88e',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'growth',
    '9f5e68b4-814a-427a-835e-d325247f7b77',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'growth',
    '6dde9f23-fb44-4f5c-83c6-75ccc4226477',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'scale',
    '910fc79d-a09a-4c0f-9c66-1a8128b96cd4',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'scale',
    '335a04a7-ca00-42c3-aee2-510cc4ecdd72',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'starter',
    '33f7c567-06ec-41dc-959a-e14dac7f45ce',
    NOW(),
    NOW()
),
...
(
    ...
    NULL,
    'growth',
    'efbecbcd-547c-469d-bac1-7596c244d9d4',
    NOW(),
    NOW()
);
