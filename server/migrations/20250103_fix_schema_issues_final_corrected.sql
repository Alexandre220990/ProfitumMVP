...
-- 9. Créer la vue principale pour les assignations (CORRIGÉE avec tous les noms corrects)
...
-- 11. Créer la fonction de statistiques (CORRIGÉE avec tous les noms corrects)
