-- =====================================================
-- NETTOYAGE SIMPLIFIÉ : Suppression des Tables en Minuscules
-- Date : 2025-01-03
...
-- ===== 6. OPTIMISATION DES INDEX (SIMPLIFIÉE) =====

-- Recréer seulement les index essentiels avec les colonnes qui existent
...
BEGIN
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'NETTOYAGE SIMPLIFIÉ TERMINÉ AVEC SUCCÈS !';
    RAISE NOTICE '====================================================';
    ...
    RAISE NOTICE '✅ Index essentiels optimisés';
