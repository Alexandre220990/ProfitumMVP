-- =====================================================
-- MIGRATION : Création des tables Marketplace Experts (VERSION PROPRE)
-- Date : 2025-01-03
...
BEGIN
    IF TG_OP = 'INSERT' THEN
        INSERT INTO "ExpertAssignmentAudit" (
            expert_assignment_id, action, user_type, details
        ) VALUES (
            NEW.id, 'created', 'expert', 
...
-- =====================================================
-- POLITIQUES RLS (Row Level Security) - SIMPLIFIÉES
-- =====================================================
