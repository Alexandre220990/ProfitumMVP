...
-- 9. Créer la vue principale pour les assignations (CORRIGÉE avec name pour Expert)
...
-- 10. Créer la vue pour les messages avec informations utilisateur (CORRIGÉE avec name pour Expert)
...
-- 11. Créer la fonction de statistiques (CORRIGÉE avec name pour Expert)
...
-- 13. Créer la vue pour les rapports (CORRIGÉE avec tous les noms corrects)
...
-- 14. Créer des politiques RLS plus avancées (CORRIGÉES avec tous les noms corrects)
DO $$
BEGIN
