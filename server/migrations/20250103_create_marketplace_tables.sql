-- =====================================================
-- MIGRATION : Création des tables Marketplace Experts
-- Date : 2025-01-03
...
CREATE TABLE IF NOT EXISTS "ExpertAssignmentAudit" (
    ...
    CONSTRAINT expert_assignment_audit_timestamp_idx UNIQUE (expert_assignment_id, timestamp)
);
...
CREATE TABLE IF NOT EXISTS "Message" (
    ...
    -- Index pour performance
    CONSTRAINT message_conversation_idx UNIQUE (client_id, expert_id, created_at)
);
...
CREATE TABLE IF NOT EXISTS "Notification" (
    ...
    -- Index pour performance
    CONSTRAINT notification_user_read_idx UNIQUE (user_id, user_type, created_at)
);
...
CREATE INDEX IF NOT EXISTS idx_expert_assignment_audit_user ON "ExpertAssignmentAudit"(user_id);
...
BEGIN
    IF TG_OP = 'INSERT' THEN
        INSERT INTO "ExpertAssignmentAudit" (
            expert_assignment_id, action, user_id, user_type, details
        ) VALUES (
            NEW.id, 'created', NEW.expert_id, 'expert', 
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        INSERT INTO "ExpertAssignmentAudit" (
            ...
            NEW.id, 'updated', NEW.expert_id, 'expert',
            jsonb_build_object(
