-- =====================================================
-- CRÉATION DE LA STRUCTURE OPTIMISÉE DU QUESTIONNAIRE
-- Date: 2025-01-07
-- =====================================================

-- 1. Créer la table QuestionnaireQuestion avec la nouvelle structure
...
-- 3. Contrainte d'unicité sur l'ordre des questions
...
-- 6. Insérer les questions optimisées
...
-- Question 1: Secteur d'activité (avec règles sectorielles intégrées)
...
-- Question 2: Chiffre d'affaires (question générale)
...
-- Question 3: Nombre d'employés (pour URSSAF/DFS)
...
-- Question 4: Locaux professionnels (pour FONCIER)
...
-- Question 5: Contrats énergie (pour ENERGIE/CEE)
...
-- Question finale: Objectifs prioritaires (toujours en dernier)
