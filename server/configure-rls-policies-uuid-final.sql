-- Configurer des politiques RLS finales avec clientId en UUID
-- Date: 2025-01-24
...
-- auth_id est de type UUID, auth.uid() retourne UUID
...
-- clientId est de type UUID, auth.uid() retourne UUID, donc on convertit clientId en text
